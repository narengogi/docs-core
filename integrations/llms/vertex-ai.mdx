...
Using service account json is a secure way to authenticate your requests to Vertex AI.
Portkey generates a temporary token using your service account json and uses it to authenticate your requests to Vertex AI.
These tokens are valid for 1 hour and are automatically refreshed when they expire.
